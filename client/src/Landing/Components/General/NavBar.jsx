...
const NavBar = () => {
  const linkStyles =
    "transition-all hover:-translate-y-0.5 hover:bg-[#c0f5b7] hover:text-black p-2 rounded-full hover:shadow-[0_10px_25px_-15px_rgba(0,0,0,0.4)]";

  return (
    <nav className="flex items-center justify-between text-l w-full max-w-5xl text-white py-3">
      <Link to="/" className="flex items-center justify-center gap-1 text-black font-bold py-2 transition-all">
